...
public class TestActivityTest {
    ...
    public void ViewMatchers() {
        ...
        Espresso.onView(Matchers.allOf(ViewMatchers.withId(R.id.button), ViewMatchers.withText("HaHa")));
        Espresso.onView(Matchers.allOf(ViewMatchers.withId(R.id.button), Matchers.not(ViewMatchers.withText("HaHa"))));
    }

    @Test
    public void ViewActions() {
        Espresso.onView(ViewMatchers.withId(R.id.button)).perform(ViewActions.click());
        Espresso.onView(ViewMatchers.withId(R.id.button)).perform(ViewActions.typeText("HaHa"), ViewActions.click());
        Espresso.onView(ViewMatchers.withId(R.id.button)).perform(ViewActions.scrollTo(), ViewActions.click());
    }

    @Test
    public void ViewAssertions() {
        Espresso.onView(ViewMatchers.withId(R.id.button)).perform(ViewActions.click());
        Espresso.onView(ViewMatchers.withId(R.id.button2)).check(ViewAssertions.matches(ViewMatchers.withText("HaHa")));
    }
